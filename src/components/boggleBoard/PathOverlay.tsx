  ...
  return (
    ...
    >
      ...
      {selectedWord.path.map((pos, index) => {
        ...
        const nextPos = tilePositions[`${selectedWord.path[index + 1].row}-${selectedWord.path[index + 1].col}`];
      ...
      {selectedWord.path.length > 0 && (
        <circle
          cx={tilePositions[`${selectedWord.path[0].row}-${selectedWord.path[0].col}`]?.x}
          cy={tilePositions[`${selectedWord.path[0].row}-${selectedWord.path[0].col}`]?.y}
          r="6"
          fill="#10b981"
          className="animate-pulse"
        />
